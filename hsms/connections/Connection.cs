...
namespace Semi.Hsms
{
    public class Connection
    {
        ...
        /// 
        /// </summary>
        protected Timer _timerT36TransactionTimeout;
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        public event EventHandler T3Timeout;
        #endregion
        ...
        public Connection(Configurator configurator)
        {
            ...
            _timerT36TransactionTimeout = new Timer(s => CheckTransactions(),
        ...
        private void CheckTransactions()
        {
            lock (_mLock)
            {
                ...
                var minTransactionTimeToKeep = currentTime - _config.T3 * 1000;

                var toRemove = _transactions.Where(x => x.Value.Timestamp >= minTransactionTimeToKeep)
                    .Select(x => x.Key)
                    .ToList();
                ...
                foreach (var key in toRemove)
                {
                    ...
                    T3Timeout?.Invoke(this, EventArgs.Empty);
                }
            }
        }
        #endregion
